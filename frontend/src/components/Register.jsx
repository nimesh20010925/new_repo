...
export default function Register({ onAuth, switchToLogin }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-white to-green-50 flex items-center justify-center px-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-6xl grid lg:grid-cols-2 gap-8 lg:gap-10 items-center z-10">
        ...
        <div className="hidden lg:flex flex-col items-center justify-center text-center px-6 lg:px-10">
          ...
          <h2 className="text-2xl lg:text-3xl font-bold text-gray-800 mb-4 lg:mb-6">
            Securely Monitor Your Child's Bright Future
          </h2>
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-6 sm:p-8 lg:p-10 border border-gray-100 w-full">
          <div className="text-center mb-6 sm:mb-8">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-gray-800">
              Create Your NutriBuddy Account
            </h2>
            <p className="text-gray-600 text-sm sm:text-base mt-1 sm:mt-2">
              Start monitoring your child's growth journey today
            </p>
          </div>
          ...
          <form onSubmit={submit} className="space-y-4 sm:space-y-6">
            ...
            <div className="relative">
              ...
              <input
                ...
                required
                className="w-full pl-10 sm:pl-14 pr-4 py-3 sm:py-4 rounded-2xl border border-gray-200 focus:border-teal-500 focus:ring-2 focus:ring-teal-100 text-gray-800 placeholder-gray-400 outline-none transition-all"
              />
            </div>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-gradient-to-r from-teal-500 to-cyan-500 hover:from-teal-600 hover:to-cyan-600 text-white font-bold py-3 sm:py-4 rounded-2xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            >
              {isLoading ? (
